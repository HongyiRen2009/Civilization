const confirmation = [
  ...
  },
  {
    ...
    description:
      "Do you want a tutorial for this game (highly recommended for new players)",
    choices: [
      {
        text: "Yes",
        effect() {
...
const popups = [
  {
    ...
    choosetext() {
      if (
        resources <
        difficulty ** 3 / 200 -
          (difficulty ** 3 / 200) * (techstats.diplomacy + 1)
      ) {
...

  {
    ...
    size: "30px",
    description:
      "The peasants are revolting due to them being unhappy with your rule",
    choosetext() {
      ...
      },
      {
        ...
        effect() {
          ...
          resources -= Math.floor(
            (difficulty ** 2.7 / 50) * (techstats.diplomacy + 1)
          );
          reputation -= getRandomInt(3, 5);
          displayUI();
  ...
  },
  {
    ...
    size: "25px",
    description:
      "The beast circles our village with intent to destroy. What should we do?",
    choosetext() {
  ...
  },
  {
    ...
    size: "25px",
    description:
      "The beast charges at our village blasting fire. What should we do?",
    choosetext() {},
    choices: [
      {
        text: "Fight",
    ...
    choices: [
      {
        ...
        effect() {
          ...
          if (military > wars[random_war].power * randomm) {
            wars[random_war].power -= Math.floor(
              wars[random_war].power * randomm
            );
            information[44].choosetext(
  ...
  },
  {
    ...
    choosetext() {
      ...
      if (power > military) {
        ...
        this.choices[0].resourceamount =
          Math.floor((100 * power) / military) * -1;
      } else {
...
const information = [
  ...
  },
  {
    ...
    size: "30px",
    description:
      "You defeated the raiders and captured their soldiers. <strong class = 'color-g'>+33% population</strong>",
  ...
  },
  {
    ...
    size: "30px",
    description:
      "Safety is the first priority. -33% resource and food production",
    choosetext() {},
    choices: [
      {
        text: "close",
  ...
  },
  {
    ...
    size: "30px",
    description:
      "The plague arrived and decimated your people. -50% population",
    choosetext(amount) {
  ...
  },
  {
    ...
    choosetext(amount) {
      this.description = `You negotiated with the enemy. -${shorten(
        amount
      )} resources`;
    },
    choices: [
  ...
  },
  {
    ...
    description:
      "We decided to be nice and let the refugees in. -20% population",
    choosetext(amount) {
  ...
  },
  {
    ...
    description: `You rebuilt the housing. -${Math.ceil(
      resources / 2
    )} resources`,
    choosetext() {
      this.description = `You rebuilt the housing. -${Math.ceil(
        resources / 2
      )} resources`;
    },
    choices: [
    ...
    choices: [
      {
        ...
        effect() {
          if (istutorial) {
            ...
            document.getElementById("popup_block_buttons").style.display =
              "none";
            document.getElementById("popup").style.display = "none";
          }
        },
