...
const tutorial = [
{
	...
	description: 'This is the market, where you can buy and sell items for resources. Being a benevolent ruler increases your <strong class = "color-g">reputation</strong>, which lowers prices in the market.',
	choices: [
	{
		text: "okay",
		effect(){
