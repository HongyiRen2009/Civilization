    ...
    marketselections: [
        {
            ...
            turnmodify() {
                this.price += Math.round(
                    Math.min(
                        getRandomInt(-3, 3) +
                            (this.whichthing == 'resources' ? this.stock - 4 : 4 - this.stock) +
                            difficulty / 5,
                        5
                    )
                );
                this.amountincrease = Math.floor(
                    (difficulty ** 2.8 / 64) * (getRandomInt(8, 12) / 10)
                );
                this.price -= Math.floor(reputation / 5);
                this.price = Math.min(
                    Math.max(this.price, Math.ceil(difficulty) + 3),
                    difficulty * 2
                );
            },
            choosetext() {
                ...
                this.description = `Hire mercenaries to fight for you. <br>+${shorten(
                    this.amountincrease
                )} military for 10 turns.`;
            },
            purchaseeffect() {
        ...
        },
        {
            ...
            turnmodify() {
                ...
                this.amountincrease += Math.round(
                    Math.min(
                        getRandomInt(-3, 3) +
                            (this.whichthing == 'resources' ? 4 - this.stock : this.stock - 4) +
                            difficulty / 15,
                        5
                    )
                );
                this.price -= Math.floor(reputation / 5);
                this.price = Math.min(
                    Math.max(this.price, Math.ceil(difficulty / 2) + 3),
                    difficulty * 2
                );
                this.amountincrease = Math.min(
                    Math.max(this.price, Math.ceil(difficulty / 3) + 3),
            ...
            choosetext() {
                ...
                this.description = `Request supply wagon deliveries. <br>+${shorten(
                    this.amountincrease
                )} food for 15 turns`;
            },
            purchaseeffect() {
        ...
        },
        {
            ...
            turnmodify() {
                ...
                this.amountincrease = Math.min(
                    Math.max(this.price, Math.ceil(difficulty / 4) + 3),
                    Math.floor(difficulty * 1.5)
                );
            },
            whichthing: 'resources',
            ...
            choosetext() {
                ...
                this.description = `Buy slaves from neighboring tribes. <br>+${shorten(
                    this.amountincrease
                )} population`;
            },
            purchaseeffect() {
        ...
        },
        {
            ...
            choosetext() {
                ...
                this.description = `Sell slaves to neighboring tribes. <br>+${
                    shorten(this.price) * this.pricemod
                } resources`;
            },
            purchaseeffect() {
                resources += Math.floor(this.price * this.pricemod);
        ...
        },
        {
            ...
            turnmodify() {
                ...
                this.amountincrease = Math.floor(
                    (difficulty ** 2.9 / 64) * (getRandomInt(8, 12) / 10)
                );
                this.price -= Math.floor(reputation / 5);
                this.price = Math.min(
                    Math.max(this.price, Math.ceil(difficulty) + 3),
            ...
            choosetext() {
                ...
                this.description = `Agree to support their tribes militarily. <br>+${
                    shorten(this.price) * this.pricemod
                } resources but lose ${shorten(this.amountincrease)} military for 10 turns.`;
            },
            purchaseeffect() {
                resources += Math.floor(this.price * this.pricemod);
        ...
        },
        {
            ...
            title: 'Foreign Aid',
            description:
                "Supply neighboring tribes with foreign aid.<br><strong class = 'color-g'>Increases reputation</strong>",
        ...
        },
        {
            ...
            choosetext() {
                ...
                this.description = `Acquire a loan for ${shorten(
                    this.amountincrease
                )} resources for 20 turns at a 30% intrest`;
            },
            purchaseeffect() {
        ...
        },
        {
            ...
            choosetext() {
                ...
                this.description = `Grant a loan for ${shorten(
                    this.price / 2
                )} resources for 10 turns at a 30% interest`;
            },
            purchaseeffect() {
        ...
        },
        {
            ...
            choosetext() {
                ...
                this.description = `HIre criminals to hijack supply wagons. <br>+${shorten(
                    this.amountincrease
                )} food for 15 turns`;
            },
            purchaseeffect() {
        ...
        },
        {
            ...
            choosetext() {
                ...
                this.description = `Hire and arm criminal groups to fight for you. <br>+${shorten(
                    this.amountincrease
                )} military for 10 turns.`;
            },
            purchaseeffect() {
        ...
        },
        {
            ...
            choosetext() {
                ...
                this.description = `Buy kidnapped people from a crime groups. <br>+${shorten(
                    this.amountincrease
                )} population`;
            },
            purchaseeffect() {
        ...
        },
        {
            ...
            title: 'Assassin',
            description:
                "Hire an assassin to assassinate your enemy's generals.<br>Reduce the chance of being attacked",
            image: "<img src = 'images/marketSword.png' width='50' height='50'></img>",
            amountincrease: 0,
            stock: 1,
            turnmodify() {
        ...
        },
        {
            ...
            title: 'Infiltrate',
            description:
                "Hire a spy to infiltrate your enemy's kingdom.<br> Increased military against that kingdom",
            image: "<img src = 'images/marketCloak.png' width='40' height='70'></img>",
            amountincrease: 0,
            stock: 1,
            turnmodify() {
        ...
        },
        {
            ...
            title: 'Propaganda',
            description:
                'Hire a sham philosopher to spread fake news. <br> Reduced chance for rebellions',
        ...
        },
        {
            ...
            description:
                "An ancient artifact of unknown origins.<br><strong class = 'color-r'>Warning! Harboring this artifact may attract a beast of ultimate power.</strong>",
        ...
        if (el.stock > 0) {
            ...
            if (!el.allowed) {
                if (el.whichthing == 'resources') {
                    buy.innerHTML = `<strong class = 'color-r'>${shorten(
                        Math.floor(el.price * el.pricemod)
                    )} ${el.whichthing}</strong>`;
                } else {
                    buy.innerHTML = `<strong class = 'color-r'>${shorten(
                        Math.floor(el.amountincrease)
                    )} ${el.whichthing}</strong>`;
                }
                buy.disabled = true;
            } else {
                if (el.whichthing == 'resources') {
                    buy.innerHTML = `<strong class = 'color-g'>${shorten(
                        Math.floor(el.price * el.pricemod)
                    )} ${el.whichthing}</strong>`;
                } else {
                    buy.innerHTML = `<strong class = 'color-g'>${shorten(
            ...
            buy.onclick = function () {
                ...
                for (let j = 0, len = marketitemsindex.length; j < len; j++) {
                    if (
                        document.getElementById(j < 4 ? 'm' + j : 'bm' + j) != null &&
                        marketitemsindex[j].stock >= 0
                    ) {
                        marketitemsindex[j].choosetext();

                        document.getElementById(j < 4 ? 'm' + j : 'bm' + j).disabled =
                            !marketitemsindex[j].allowed || marketitemsindex[j].stock <= 0;

                        document.getElementById(
                            j < 4 ? 'm' + j : 'bm' + j
                        ).innerHTML = `<strong class = 'color-${
                            marketitemsindex[j].allowed ? 'g' : 'r'
                        }'>${shorten(
                            Math.floor(
                                marketitemsindex[j].whichthing === 'resources'
                                    ? marketitemsindex[j].price * marketitemsindex[j].pricemod
                                    : marketitemsindex[j].amountincrease
                            )
                        )} ${marketitemsindex[j].whichthing}</strong>`;
                    }
                }
                document.getElementById('mresource').innerHTML = 'Resources: ' + shorten(resources);
                document.getElementById('mreputation').innerHTML = 'Reputation: ' + reputation;
            ...
            if (i == 3 && reputation < 100) {
                flex.innerHTML =
                    "<h1 class = 'color-r' style = 'font-size: 28px;'> Requires 100 Reputation</h1>";
            }
        } else {
            flex.innerHTML = "<h1 class = 'color-g'>SOLD OUT</h1>";
        }
...
function selectmarketitems() {
    ...
    marketitems.push(
        ...
        getRandomInt(3, 4),
        getRandomInt(5, 9),
        m.marketselections.length - 2,
        getRandomInt(10, 15),
        getRandomInt(10, 15),
        m.marketselections.length - 1
    );
}
